...
- What LDO to use?
    - We have selected an extended part, so far. Can we change that?
    - [30V, 3.3V, SOT-89-3](https://jlcpcb.com/partdetail/HoltekSemicon-HT75331/C14289) -> that would work
        - I'm not sure why I seem to have overlooked this earlier.
        - It is larger so not so easy to change it now.
    - [36V, adjustable, SOT-23](https://jlcpcb.com/partdetail/3500-CJ431/C3113) -> it is a voltage reference but 100 mA is more than enough for us
    - [36V, step-down, SOIC-8](https://jlcpcb.com/partdetail/TexasInstruments-TPS5430DDAR/C9864) -> 3 mA quiescent current is too much
- Do we use voltage doubler or inverter?
    - Too much area, too little gain - at least for voltage doubler.
    - Voltage inverter doesn't [look to great either][sim7].
    - There is an inductor basic part: [10 uH, 15 mA, 0805](https://jlcpcb.com/partdetail/Sunlord-SDFL2012S100KTF/C1046).
      That could be enough. There is also one with 3 mA in 0603.
    - 10 uH/U*I
        - at 10V, with 2 mA: 2 us
        - at 3.3V, with 2 mA: 6 us
...
[sim7]: https://falstad.com/circuit/circuitjs.html?ctz=
[sim8]: https://falstad.com/circuit/circuitjs.html?ctz=--QxSoMkAsGgEosHiwqzGoaLFveYBwZu2LBJsmQnrkZ5xEkaRBoe954Uhahekyt6KBE-ZUs85KYH2FjmEeUjUVYEh4Z2BpVBiHHaM24CWvE1q2rwHwGDoLDfmxQkArYYkMUGDY0gU+zYgA9kcvEKJgYwxtgfjMGprDztoUCcKpkAYBAGlaQ89iyHpZlQOpvGQJwQA
